...
<!-- Mirrored from coderthemes.com/hyper/modern/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Mar 2024 05:36:04 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body class="authentication-bg position-relative">
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            <div align="center">
                                <br />
                             <span><img src="Template/modern/assets/images/logo.png" alt="logo" height="150"></span>
                            </div>
                                <!-- Logo -->
                            <div class="card-body p-4">
                                ...
                                <form action="#">
                                    ...
                                    <div class="mb-3 mb-0 text-center">
                                      <a href="/Pages/ViewSurvey" class="btn btn-primary"><i class="mdi mdi-login"></i> Log In.</a>
        ...
        <footer class="footer footer-alt">
             <script>document.write(new Date().getFullYear())</script> © VALU Quest
        </footer>
        <!-- Vendor js -->
