        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="correctionsTable" class="display table table-hover">
                        <thead>
                            <tr>
        ...
        function initializeDataTable(data) {
            ...
            <tr class="master-row" data-id="${masterRow.correctionId}">
                ...
                group.details.forEach(detail => {
                    const detailRowHtml = `
                <tr class="child-row" data-parent-id="${masterRow.correctionId}" style="display:none;">
                    <td colspan="8">
                        <strong>Condition Type:</strong> ${detail.conditionType}<br>
                        <strong>Operator:</strong> ${detail.operator}<br>
                        <strong>Condition Value 1:</strong> ${detail.conditionValue1}<br>
                        <strong>Condition Value 2:</strong> ${detail.conditionValue2}<br>
                        <strong>Conjunction:</strong> ${detail.conjunction}<br>
                        <strong>Block Info:</strong> ${detail.BlockInfo}<br>
                    </td>
                </tr>`;
