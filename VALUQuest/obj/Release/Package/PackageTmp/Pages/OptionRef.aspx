...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#ddlBlock, #ddlCategory, #ddlSubCategory, #ddlQuestion').change(function () {
                // Clear the table
            ...
            $('#ddlBlock').change(function () {
                ...
                $('#ddlSubCategory').empty().append('<option value="-1">--Seleziona--</option>');
            ...
            $('#ddlSubCategory').change(function () {
                ...
                var subCatId = document.getElementById('ddlSubCategory').value;
                loadQuestions(subCatId);
        ...
        function changeSubCategory(catId, subcatId) {
            ...
            setTimeout(function () {
                $.ajax({
                    type: "POST",
                    url: "/Pages/OptionRef.aspx/GetSubCategories",
        ...
        function loadQuestions(subCatId) {
