...
namespace VALUQuest.Pages
{
    public partial class Block : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string UpdateData(string blockId, string blockName)
        {
            try
            {
                Utility.DatabaseHelper db = new Utility.DatabaseHelper();
                ...
                int rowsAffected = db.ExecuteStoredProcedure("sp_UpdateBlockData",
                    pBlockId,
                    pBlockName,
                    pModifiedBy,
                    pModifiedDate);
        ...
        [WebMethod]
        public static string DeleteData(string blockId)
        {
            try
            {
                Utility.DatabaseHelper db = new Utility.DatabaseHelper();
                ...
                int rowsAffected = db.ExecuteStoredProcedure("sp_DeleteBlockData",
                    pBlockId,
                    pDeletedBy,
                    pDeletedDate);
