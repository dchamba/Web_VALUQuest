<%@ Page Title="Question Tree" Language="C#" MasterPageFile="~/Template/ValuMaster.Master" AutoEventWireup="true" CodeBehind="QuesTree3.aspx.cs" Inherits="VALUQuest.Pages.QuesTree3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tree-controls mb-3">
                               ...
                               <div class="mb-3">
                                <button id="btnAddMasterQuestion" class="btn btn-primary" data-bs-toggle="modal" 
                    data-bs-target="#masterModal">
                                    <i class="fa fa-plus"></i>Add Master Question
                                </button>
                            </div>
    ...
    <script>
        ...
        function loadFancyTree() {
            $.ajax({
                type: "POST",
                url: "/Pages/QuesTree3.aspx/GetQuestionTreeData",
...
function getRootMasterQuestionId(node) {
    ...
    return rootQuestionId;
        ...
        function reloadTree() {
            $.ajax({
                type: "POST",
                url: "/Pages/QuesTree3.aspx/GetQuestionTreeData", // Ensure this matches your WebMethod URL for fetching tree data
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    let treeData = typeof response.d === "string" ? JSON.parse(response.d) : response.d;
